...
function inicio() {
    ...
    $("input[name=busqueda]").keyup(function () {
        ...
        mostrarDatos2(textobuscar, 1, valoroption);
    });
    ...
    $("body").on("click", "#pag li a", function (e) {
        ...
        valoroption = $("#cantidad").val();
        mostrarDatos2(valorBuscar, valorhref, valoroption);
    });

    $("#cantidad").change(function () {
        valoroption = $(this).val();
        valorBuscar = $("input[name=busqueda]").val();
        mostrarDatos2(valorBuscar, 1, valoroption);
    });
...
function mostrarDatos2(valorBuscar, pagina, cantidad) {
